...
st.write(
    "On observe qu'avant 15 ans, les femmes sont heureusement peu touchées par les féminicides par rapport à leur proportion dans la population globale. "
...
st.markdown(
    """Avant 20 ans, la proportion de féminicides est très inférieure à la population globale. Ensuite malheureusement, le pourcentage de féminicides devient supérieur à la population glabale, jusqu'à 65 ans.          
