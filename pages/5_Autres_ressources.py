...
st.write(
    "Pour en savoir plus sur le sujet des féminicides, voici quelques ressources supplémentaires :"
)
st.markdown(
    """
...
st.write(
    "N'hésitez pas à consulter ces ressources pour obtenir des informations, du soutien et des moyens d'agir contre les violences faites aux femmes."
)
