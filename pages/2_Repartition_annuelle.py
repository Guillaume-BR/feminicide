...
fig_annee = px.bar(
    x=nb_fem.index, y=nb_fem.values, labels={"x": "Année", "y": "Nombre de féminicides"}
)
...
st.write(
    "Le nombre de féminicides est malheureusement constant au cours du temps. La baisse observée en 2025 vient seulment du fait que les données s'arrêtent en août 2025. "
