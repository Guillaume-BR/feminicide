...
fig_pie = px.pie(values=tab_count.values, names=tab_count.index, width=800, height=500)

st.plotly_chart(fig_pie)

st.markdown(
    """Non, les femmes ne sont pas tuées par des inconnus mais surtout par **des gens de leur entourage proche** et notamment
