...
st.markdown(
    "Merci au collectif #NousToutes pour leur travail de recensement et de sensibilisation aux féminicides en France."
)
st.markdown(
    "N'hésitez pas à répondre ou à consulter le résultat de leurs [enquêtes](https://www.noustoutes.org/enquetes/)."
)
